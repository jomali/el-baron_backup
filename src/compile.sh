...
if [ -e "../../nginx-1.10.3/html/baron/resources/$gameFile.gblorb" ]; then
	rm ../../nginx-1.10.3/html/baron/resources/$gameFile.gblorb
fi
...
cp $gameFile.gblorb ../../nginx-1.10.3/html/baron/resources/$gameFile.gblorb
